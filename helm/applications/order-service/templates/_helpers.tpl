...
{{/*
Resolve the Secret that provides Artemis credentials.
*/}}
{{- define "order-service.artemisSecretName" -}}
{{- if .Values.artemis.credentials.existingSecret }}
{{- .Values.artemis.credentials.existingSecret }}
{{- else }}
{{- printf "%s-artemis" (include "order-service.fullname" .) }}
{{- end }}
{{- end }}
